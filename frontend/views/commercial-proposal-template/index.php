...
$this->title = 'Шаблоны коммерческих предложений';
$this->params['breadcrumbs'][] = $this->title;

?>

<div class="commercialproposaltemplate-index">
    <div class="box box-default">
        <div class="box-header with-border">
            <?php if (Yii::$app->user->identity->checkRule('commercial-proposal-templates', 2)): ?>
        ...
        <?= GridView::widget([
            ...
            'columns' => [
                'id' => [
                    ...
                    'format' => 'html',
                    'value' => function($data) {
                        if (Yii::$app->user->identity->checkRule('commercial-proposal-templates', 2)) {
