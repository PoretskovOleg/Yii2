...
use frontend\assets\CommercialProposal\CommercialProposalTemplateFormAsset;
use yii\widgets\Pjax;

CommercialProposalTemplateFormAsset::register($this);
...
<div class="template-form">
    ...
    <div class="box box-default">
            ...
            <div class="form-promo-file">
                <?php if (isset($model->promos_filenames['2'])): ?>
                        <div class="row form-group">
                            ...
                            <div class="col-md-4">
                                <?= Html::img(
                                    Yii::getAlias('@commercial_proposals/promos/') . $model->promos_filenames['2'],
            ...
            <div class="form-promo-file">
                <?php if (isset($model->promos_filenames['5'])): ?>
                    <div class="row form-group">
                        ...
                        <div class="col-md-4">
                            <?= Html::img(
                                Yii::getAlias('@commercial_proposals/promos/') . $model->promos_filenames['5'],
                                ['class' => 'img-responsive img-thumbnail']
                            ) ?>
                        </div>
                    </div>
            ...
            <div class="form-promo-file">
                <?php if (isset($model->promos_filenames['8'])): ?>
                    <div class="row form-group">
                        ...
                        <div class="col-md-4">
                            <?= Html::img(
                                Yii::getAlias('@commercial_proposals/promos/') . $model->promos_filenames['8'],
                                ['class' => 'img-responsive img-thumbnail']
                            ) ?>
                        </div>
                    </div>
        ...
        <div class="box-footer">
            <div class="pull-right">
                ...
                <?= Html::submitButton('Сохранить',
                    ['id' => 'commercial-proposal-template_submit', 'class' => 'btn btn-primary'])
                ?>
            </div>
        </div>
        <?php ActiveForm::end(); ?>
        ...
        <?php
            $pdf_url = \yii\helpers\Url::toRoute('commercial-proposal-template/get-pdf?id=' . $model->id);
