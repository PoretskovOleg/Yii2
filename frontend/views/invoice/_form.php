...
use frontend\assets\Invoice\InvoiceFormAsset;
...
<div class="template-form">
    <?php Pjax::begin(['id' => 'invoice_edit', 'formSelector' => '#invoice_form']); ?>
    ...
    <div class="box box-default">
        ...
        <div class="box-body">
            ...
            <div class="form-group">
                <label class="control-label col-md-2">Примечание</label>
                <div class="col-md-9">
                    <div style="height: 200px; overflow-y: auto;" class="form-control" id="note">
                        <?= $model->note ?>
                    </div>
                </div>
            </div>
            ...
            <?php
                ...
                foreach ($model->files as $file) {
                    ...
                    $initialPreview[] = '<a target="_blank" href="'
                        . Yii::getAlias('@web')
                        . Yii::getAlias('@invoices_attachments/')
    ...
    <div class="box box-default">
        <div class="box-body">
            <div class="pull-right">
                ...
                <?php if ($model->status_id !== $model::STATUS_SENT || $permissions['can_edit_after_send']): ?>
                    <?= Html::submitButton('Сохранить', ['id' => 'invoice_submit', 'class' => 'btn btn-primary']) ?>
        ...
        <?php
            $pdf_url = \yii\helpers\Url::toRoute('invoice/get-pdf?id=' . $model->id);
    ...
    <div class="modal fade" id="send_email_modal" tabindex="false" role="dialog" aria-labelledby="send_email_modal_label">
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?= $this->render('pjax/_send_email_form', ['model' => $emailModel, 'invoice_id' => $model->id]) ?>
                </div>
            </div>
        </div>
    </div>
