...
use \frontend\assets\CommercialProposal\CommercialProposalIndexAsset;

CommercialProposalIndexAsset::register($this);

$this->title = 'Реестр коммерческих предложений';
$this->params['breadcrumbs'][] = $this->title;

?>

<div class="commercialproposal-index">
    <?php Pjax::begin() ?>
    ...
    <div class="box box-default">
        <div class="box-header with-border">
            <?php if (Yii::$app->user->identity->checkRule('commercial-proposals', 2)): ?>
