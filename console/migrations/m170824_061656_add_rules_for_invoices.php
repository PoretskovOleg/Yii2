...
class m170824_061656_add_rules_for_invoices extends Migration
{
    public function safeUp()
    {
        ...
        $module_name = frontend\controllers\InvoiceController::MODULE_NAME;
        //массив правил [['id' => '1', 'name' => 'Правило 1'], ['id' => '2', 'name'...
        $rules = frontend\controllers\InvoiceController::getUserRules();
