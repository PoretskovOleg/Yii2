...
class m170819_210327_add_rules_for_commercial_proposals extends Migration
{
    public function safeUp()
    {
        //название модуля для отображения в старой админке
        $module_title = 'Коммерческие предложения';
        //название модуля для использования в checkRule($module_name, $rule_id)
        $module_name = frontend\controllers\CommercialProposalController::MODULE_NAME;
        //массив правил [['id' => '1', 'name' => 'Правило 1'], ['id' => '2', 'name'...
        $rules = frontend\controllers\CommercialProposalController::getUserRules();
