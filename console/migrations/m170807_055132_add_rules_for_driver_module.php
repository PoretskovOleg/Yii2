...
class m170807_055132_add_rules_for_driver_module extends Migration
{
    public function safeUp()
    {
        ...
        $module_name = frontend\controllers\DriverTripsController::MODULE_NAME;
        //массив правил [['id' => '1', 'name' => 'Правило 1'], ['id' => '2', 'name'...
        $rules = frontend\controllers\DriverTripsController::getUserRules();
