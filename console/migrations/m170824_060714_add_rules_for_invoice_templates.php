...
class m170824_060714_add_rules_for_invoice_templates extends Migration
{
    public function safeUp()
    {
        //название модуля для отображения в старой админке
        $module_title = 'Шаблоны счетов';
        //название модуля для использования в checkRule($module_name, $rule_id)
        $module_name = frontend\controllers\InvoiceTemplateController::MODULE_NAME;
        //массив правил [['id' => '1', 'name' => 'Правило 1'], ['id' => '2', 'name'...
        $rules = frontend\controllers\InvoiceTemplateController::getUserRules();
