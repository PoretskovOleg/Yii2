...
class m170804_080204_add_rules_for_brands extends Migration
{
    public function safeUp()
    {
        ...
        $module_name = \frontend\controllers\BrandController::MODULE_NAME;
        //массив правил [['id' => '1', 'name' => 'Правило 1'], ['id' => '2', 'name'...
        $rules = \frontend\controllers\BrandController::getUserRules();
